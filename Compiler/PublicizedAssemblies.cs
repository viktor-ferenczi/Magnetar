...
{
    private readonly HashSet<string> ignoredAssemblyNames = [];
    private readonly Dictionary<string, MetadataReference> publicizedReferences = [];
    ...
    public void InspectSource(SourceText source)
    {
        ...
        {
            AttributeArgumentSyntax targetAssemblyArg =
    ...
    public MetadataReference PublicizeReferenceIfRequired(
        string targetName,
    ...
    private bool GetPublicizedReference(
        string referenceName,
        MetadataReference originalReference,
        out MetadataReference publicizedRef
    )
    {
        ...
        if (
            originalReference is not PortableExecutableReference portableRef
